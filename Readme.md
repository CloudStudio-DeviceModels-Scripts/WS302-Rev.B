...
# Parsing + Configuration Script – WS302 - Rev. B

This **Parsing + Configuration** script is designed for the **WS302** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – WS302 Rev. B

Este script de **Parsing + Configuration** está diseñado para el modelo **WS302** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
